...
%creation de I_decorrelee
I_decorrelee = I;
premiere_colonne = I(:, 1);
[I_gauche, I_droite] = vectorisation(I);
decorrelation = I_droite - I_gauche;

I_decorrelee(:,1) = premiere_colonne;
I_decorrelee(:,2:end) = reshape(decorrelation,206,344);
